...
7 - Instale o flask seguindo este tutorial: https://flask.palletsprojects.com/en/2.3.x/installation/

8 - Instale o flask-mysqld com o comando: pip install flask_mysqldb

9 - Abra o arquivo api.py e coloque nas linhas 7 a 10 as informações do banco de dados que você criou no worbench. Se não tiver senha no usuário, deixe assim: ''.

10 - Rode o comando: flask --app api run --debug
